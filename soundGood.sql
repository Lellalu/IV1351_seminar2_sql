...
rented_price_per_month VARCHAR(10) NOT NULL
);
...
id INT NOT NULL,
instruments_taught VARCHAR(500) NOT NULL,
person_id INT NOT NULL
);
...
ALTER TABLE lesson_schedule ADD CONSTRAINT FK_lesson_schedule_1 FOREIGN KEY (price_id) REFERENCES lesson_price (id);
...
ALTER TABLE rental ADD CONSTRAINT FK_rental_0 FOREIGN KEY (instrument_id) REFERENCES instrument_stock (id);
